...
<ul class="nav-ul">
	...
	<center>
		<div class="view">
			<br><br><h2 style=" font-size:45px;color:White;text-shadow: 2px 2px black;">Transfer Amount</h2>
       ...
       <tr>
			<td>
				<div class="button">
				<br> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<button type="submit" value="Credit" style="color:white;font-size:18px;height:40px; width:100px;">Transfer</button>
				</div>
		   </td>
        </tr>
       </table>
	...
	<form action="user.php" method="post">
			<div class="buttons">
				<button class="primary_btn" type="submit" name="name" value="<?php echo $name1 ?>">BACK</button>
			</div>
	</form>
</center>
</body>
